...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" }, "s", function () awful.spawn("flameshot gui --accept-on-select --clipboard") end, 
    ...
    -- Force new wallpaper
    awful.key({ modkey }, "F5", function() awful.spawn.with_shell("~/.config/awesome/zenburn/cycle_wallpaper.sh") end,
              {description = "cycle wallpaper + theme", group = "awesome"})
